...
public class 	SudokuPuzzle {
	...
	public SudokuPuzzle(SudokuPuzzle puzzle) {
		new SudokuPuzzle(puzzle.ROWS, puzzle.COLUMNS, puzzle.BOXWIDTH, puzzle.BOXHEIGHT, puzzle.VALIDVALUES);
	...
	private void initSudokuPuzzle(int rows, int columns, int boxWidth, int boxHeight, String[] validValues) {
		this.ROWS = rows;
		this.COLUMNS = columns;
		this.BOXWIDTH = boxWidth;
		this.BOXHEIGHT = boxHeight;
