...
public class SudokuPanel extends JPanel {
	...
	public final float[] BLUE_TRANSPARENT = {0.0f,0.0f,1.0f,0.3f};
	private final String BLUE_HEXA = Float.toHexString(BLUE_TRANSPARENT[0]) +
									 Float.toHexString(BLUE_TRANSPARENT[1]) +
									 Float.toHexString(BLUE_TRANSPARENT[2]) +
			 						 Float.toHexString(BLUE_TRANSPARENT[3]);
	...
	public SudokuPanel() {
		...
		this.puzzle = new SudokuGenerator().generateRandomSudoku(sudokuFactory.getSudoku(9));
	...
	protected void paintComponent(Graphics g) {
		...
		g2d.setColor(new Color(WHITE[0], WHITE[1], WHITE[2]));
		...
		g2d.setColor(new Color(BLACK[RED], BLACK[GREEN], BLACK[BLUE]));
		...
		if(currentlySelectedCol != -1 && currentlySelectedRow != -1) {
			...
			//g2d.setColor(new Color(Integer.parseInt(BLUE_HEXA, 16)));
