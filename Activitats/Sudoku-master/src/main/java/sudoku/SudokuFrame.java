...
public class SudokuFrame extends JFrame {
	...
	public SudokuFrame() {
		...
		sixBySixGame.addActionListener(new NewGameListener(sudokuFactory.getSudoku(6),30));
		JMenuItem nineByNineGame = new JMenuItem("9 By 9 Game");
		nineByNineGame.addActionListener(new NewGameListener(sudokuFactory.getSudoku(9),26));
		JMenuItem twelveByTwelveGame = new JMenuItem("12 By 12 Game");
		twelveByTwelveGame.addActionListener(new NewGameListener(sudokuFactory.getSudoku(12),20));
		...
		*/
		...
		rebuildInterface(sudokuFactory.getSudoku(9), 26);
	}
